...
此目录存放 Xcode 工程配置，用于构建家庭记账本 iOS App，并声明分层后的源码文件引用、应用资源与 App 图标配置。
...
└── project.pbxproj # Xcode 工程配置，声明 App target、App/Features/Core/Shared/Resources 分组、源码文件、资源文件和构建设置。
```
